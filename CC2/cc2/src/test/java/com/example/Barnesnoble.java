...
public class Barnesnoble {
   final Logger lobj = Logger.getLogger(getClass());
    ...
    public void setup()
    {
        ExtentSparkReporter sparkReporter = new ExtentSparkReporter("D:\\Reports\\CC2\\CC2\\logandreport\\report.html");
    ...
    {
        PropertyConfigurator.configure("D:\\Reports\\CC2\\CC2\\cc2\\src\\main\\java\\com\\example\\resources\\log4j2.properties");
    ...
    {  
        FileInputStream fs=new FileInputStream("D:\\Reports\\CC2\\CC2\\author.xlsx");
    ...
    public void tearDown(ITestResult result)throws Exception
    {
        if(result.getStatus()==ITestResult.FAILURE)
        {
            ...
            String screenShotPath = "D:\\Reports\\CC2\\CC2\\logandreport\\"+result.getName()+".png";
